...
```{r load-base-data}
# Load watersheds, bathymetry, and water mask
...
watersheds <- load_watersheds(
  watershed_path = "/Users/hediyeh/Desktop/Phd_project_analyses/Chapter_1/Rmarkdown & Data/forestry/corrected_watersheds.gpkg"
)
```
...
# Save
forestry_exp <- combined_exposure
```
