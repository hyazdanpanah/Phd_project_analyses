...
# Aggregate to reduce computational load
...
# Coastal development effects propagate through water but blocked by land
...
# Calculate exposure from all binary sources
coastal_exp <- RelativeExposure(
